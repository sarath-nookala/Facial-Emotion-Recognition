...
tf.app.flags.DEFINE_string('data_input_dir', '/home/sarath/ml_project', """Path to the FER2013 data directory.""")

# Global constants describing the FER2013 data set.
IMAGE_SIZE = input3.IMAGE_SIZE
NUM_CLASSES = input3.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = input3.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = input3.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def distorted_inputs():
  ...
  return input3.distorted_inputs(data_dir=data_input_dir,
...
def inputs(eval_data):
  ...
  if not FLAGS.data_input_dir:
    raise ValueError('Please supply a data_input_dir')
  data_input_dir = os.path.join(FLAGS.data_input_dir, 'fer_data')
  return input3.inputs(eval_data=eval_data, data_dir=data_input_dir,
                              batch_size=FLAGS.batch_input_size)
